...
public class Gemm_03_Naive {
    ...
    public static void run(
        ...
        TaskGraph taskGraph = new TaskGraph(graphName) //
                ...
                .task("t0", Gemm_03_Naive::runKernel, context, a, b, c, m, k, n, alpha, beta) //
    ...
    public static void runKernel(KernelContext context, FloatArray a, FloatArray b, FloatArray c, int m, int k, int n, float alpha, float beta) {
        int x = context.groupIdx * context.localGroupSizeX + context.localIdx;
        int y = context.groupIdy * context.localGroupSizeY + context.localIdy;
