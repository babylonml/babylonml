...
public class TvmVectorOperations {
    ...
    private static void addVectorToVectorKernel(FloatArray first, int firstOffset, ByteArray second, int secondOffset,
                                                FloatArray result, int resultOffset, int length) {
        for (@Parallel int i = 0; i < length; i++) {
            result.set(resultOffset + i, first.get(firstOffset + i) + second.get(secondOffset + i));
        }
    ...
    private static void copyVectorKernel(FloatArray source, int sourceOffset,
    ...
    private static void copyVectorKernel(ByteArray source, int sourceOffset,
