...
public final class BroadcastColumns extends AbstractOperation {
    ...
    public long forwardPassCalculation() {
        ...
        MatrixOperations.broadcastVectorToMatrix(leftBuffer, leftOffset, resultBuffer, resultOffset, rows, columns);
    ...
    public long leftBackwardDerivativeChainValue() {
        ...
        MatrixOperations.reduceMatrixToVector(derivativeBuffer, derivativeOffset, rows, columns,
